...
class NewDeck extends Component {
  ...
  updateQuestionStatus = async () => {
    try {
      ...
      let updateResponse = await updateDeckApi({
        token: this.state.data.jwt,
        id: this.props.route.params.data.chapter_id,
        course_id: this.props.route.params.data.course_id,
        ...
        if (this.state.allCardData.length == 0) {
          ...
          if (this.state.allCardData.length == Number(this.state.isIndex)) {
            ...
            let updatedList = newData.map((itemss) => {
              ...
              if (itemss.card_id == newData[this.state.isIndex+1].card_id) {
                return {
                  ...itemss,
                  isAnswer: false,
                };
        ...
        {this.state.allCardData.length != 0 ? (
          <SwiperFlatList
            ...
            onChangeIndex={(index, prevIndex) => {
              ...
              if(index.index +2 !=  this.state.allCardData.length) {
                if(this.state.allCardData.length > index.index +2){
                  if (itemss.card_id == this.state.allCardData[index.index + 2] == undefined || this.state.allCardData[index.index + 1].card_id == undefined ? this.state.allCardData[index.index].card_id : this.state.allCardData[index.index + 1].card_id) {
                return {
                  ...itemss,
                  isAnswer: false,
                };
              ...
              if(this.state.allCardData.length != index.index + 1) {
                if(this.state.allCardData.length > index.index +2){
              if (itemss.card_id == this.state.allCardData[index.index + 1] == undefined || this.state.allCardData[index.index + 1].card_id == undefined ? this.state.allCardData[index.index].card_id : this.state.allCardData[index.index + 1].card_id) {
                return {
                  ...itemss,
                  isAnswer: false,
                };
              ...
              if (itemss.card_id == this.state.allCardData[index.index - 1] == undefined ? this.state.allCardData[index.index].card_id : this.state.allCardData[index.index - 1].card_id ) {
                return {
                  ...itemss,
                  isAnswer: false,
                };
                ...
                <View style={style.footerVw}>
                  {item.card_id == this.state.isCardIds ?   this.state.isAnswer  ? (
                    <CustomAnswerFooterVw
                      ...
                      rightClick={() => {
                        let updatedList = this.state.allCardData.map((itemss) => {
                        if (itemss.card_id == this.state.allCardData[this.state.isIndex+1].card_id) {
                          return {
                            ...itemss,
                            isAnswer: false,
                            };
                        ...
                        this.setState({isFirst: true, allCardData: updatedList,
                          isFlipped: false,
                        isAnswer: false,
                          })
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                this.setState({...this.state, isAudioShow: false, playState: 'paused',playSeconds: 0 });
                this.pause();
              }}
              style={{
                width: '10%',
